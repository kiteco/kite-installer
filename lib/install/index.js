          ...
          new BranchStep([
            {
              ...
              step: new VoidStep({
                name: 'not-admin',
                view: new NotAdminElement(),
              }, () => {
                // We're setting a flag that can be checked by the plugin
                // to know if it shows the install flow again or not
                localStorage.setItem('kite.no-admin-privileges', true);
              }),
            },
          ], {
            name: 'admin-check',
          ...
          new BranchStep([
            {
              ...
              step: new VoidStep({
                ...
                // We're disabling the useKite setting so as to not
                // show the install flow again.
