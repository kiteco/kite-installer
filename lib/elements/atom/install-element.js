  ...
  createdCallback() {
    ...
    <div class="install-wrapper">
      ...
      <div class="progress-indicators">
        ...
        <div class="install-finished hidden">
          <span class="inline-block icon">🎉</span>
          <span class="inline-block">Kite was successfully installed!</span>
        </div>
      </div>
    ...
    this.finished = this.querySelector('.install-finished');
  }
    ...
    this.subscriptions.add(this.install.observeState(state => {
      ...
      if (state.plugin) {
        ...
        if (state.plugin.done) {
          this.finished.classList.toggle('hidden', false);
        }
      }

      if (state.whitelist) {
        this.finished.classList.toggle('hidden', true);
      }
    }));
  }
