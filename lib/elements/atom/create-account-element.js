...
class CreateAccountElement extends HTMLElement {
  static initClass() {
    return document.registerElement('kite-atom-create-account', {
  ...
  createdCallback() {
    ...
    this.classList.add('create-account-step');
...
module.exports = CreateAccountElement.initClass();
