...
class KiteVsJediElement extends HTMLElement {
  static initClass() {
    return document.registerElement('kite-atom-kite-vs-jedi', {
  ...
  createdCallback() {
    ...
    <div class="comparison row">
      <div class="inset-panel padded jedi">
        ...
        <div class="column">
          <ul class="features">
            <li class="feature icon icon-check">Keyword and function completions</dliiv>
      ...
      <div class="inset-panel padded kite">
        ...
        <div class="column">
          <ul class="features">
            ...
            <li class="feature icon icon-check">Go-to definitions</li>
            <li class="feature icon icon-check">Usages and search (Paid features)</li>
          </ul>
          <div class="localities">
...
module.exports = KiteVsJediElement.initClass();
