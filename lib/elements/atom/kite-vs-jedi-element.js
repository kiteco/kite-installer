...
class KiteVsJediElement extends HTMLElement {
  constructor(name) {
      ...
      <div class="actions">
        <div class="cta-container">
          <button class="btn btn-primary">
            <span class="icon icon-plus"></span>Add Kite
          </button>
        </div>
        <div class="disclaimer">
          ...
          <br>
          <br>
          You may disable it at any time.
        </div>
      </div>
    </div>
    <div id="jedi" class="comparison inset-panel">
      ...
      <div class="body bordered">
        <div class="summary">
          Jedi runs locally on your computer and comes with autocomplete-python regardless of whether or not Kite is installed
        </div>
        <ul class="features">
