...
var InstallFlow = class {
  constructor(classes=[]) {
    ...
    this.element.dataset.installCopy = 'long';
    this.element.dataset.installTitle = 'thankyou';
    this.element.dataset.showKiteLogo = 'yes';
    this.element.dataset.buttonPosition = 'top';
    this.element.dataset.showScreenshot = 'yes';
  ...
  finishFlow() {
    ...
    <div class="welcome-to-kite">
      ...
      <p>Kite is under active development. Expect many new features in the coming months, including formatted documentation, jump to definition, function call signatures, and many more</p>
