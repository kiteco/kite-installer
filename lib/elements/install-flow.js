...
var InstallFlow = class {
  constructor(classes=[]) {
    ...
    this.element.setAttribute('data-installCopy', 'short');
    this.element.setAttribute('data-installTitle', 'thankyou');
    this.element.setAttribute('data-showKiteLogo', 'yes');
    this.element.setAttribute('data-buttonPosition', 'top');
    this.element.setAttribute('data-showScreenshot', 'yes');
