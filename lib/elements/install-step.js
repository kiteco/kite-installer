...
var InstallStep = class {
  constructor(classes) {
    ...
    <div data-install-copy="short">
      <p><strong>Cloud powered completions</strong></p>
      <p>1.5x as many completions and 2x documentation coverage, powered by all the open-source code on Github.  Kite achieves this by analyzing your code in the cloud.  <a href="http://kite.com/faq-autocomplete-python">Click here to learn more</a>.</p>
    </div>
