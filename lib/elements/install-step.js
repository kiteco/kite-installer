...
var InstallStep = class {
  constructor(classes) {
    ...
    kiteLocalities.appendChild(createLocality('Kite comes with a native app that syncs your code to the cloud, where it is analyzed to give you better results.', 'icon-cloud-upload'));
    ...
    jediLocalities.appendChild(createLocality('Jedi runs locally on your machine using the Jedi Python engine.', 'icon-package'));
